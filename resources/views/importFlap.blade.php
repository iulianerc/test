...
<div id="table_container">
    <div id="table_left_header__ro"><em>i<br>m<br>p<br>o<br>r<br>t</em></div>
    <div id="table_left_header__en"><b>i<br>m<br>p<br>o<br>r<br>t<br>a<br>t<br>i<br>o<br>n</b></div>
    <table id="main_table">
        <tr>
        ...
        <tr>
            <td class="null_padding" style="border: none">
                <table>
                    ...
                    <tr>
                        <td style="border-right-style: none; height: 460.3px; padding-right: 15px;">
                            <div class="letter">
                                <div>F.</div>
                                <b class="upper">temporary importation declaration/</b><br>
                                Declara&#539;ie de import temporar <br>
                            </div>
                            <br><br>
                            <div id="declaration">
                                ...
                                <div class="letter">
                                    <div>a)</div>
                                    <b>declare that I am temporarily importing in compliance with the conditions laid down in the laws and regulations of the country/Customs territory of importation,
                                        the goods enumerated in the list overleaf and described in the General List under item No.(s)/</b>
                                    <em>/ Declar că import temporar în condiţiile prevăzute de legile şi reglementările ţării/teritoriului vamal de import,
                                        mărfurile enumerate în lista ce figurează pe verso şi reluate în Lista Generală sub Nr. (numerele).</em><br>
                                    <br><br>
                                    <div
                                ...
                                <div class="letter">
                                    <div>b)</div>
                                    <b>declare that the said goods are intended for use at</b>
                                    <em>/ declar c&#259; m&#259;rfurile sunt destinate a fi utilizate la: </em><br>
                                    <br><br>
                                    <div
                                        style="border: 1px; border-style: dotted none; width: 100%; height: 20px;"></div>
                                    <br>
                                ...
                                <div class="letter">
                                    <div>c)</div>
                                    <b>undertake to comply with these laws and regulations and re-export the said goods within the period stipulated by the Customs
                                    ...
                                    <em>m&#259; angajez s&#259; respect aceste legi &#351;i reglement&#259;ri &#351;i s&#259; reexport aceste m&#259;rfuri &#238;n termenul stabilit
                ...
                <table>
                    <tr>
                        <td style="padding-right: 15px; background-color: rgb(200, 200, 200);">
                            ...
                            <div class="letter">
                                <div>a)</div>
                                <b>The goods referred to in the above declaration have been temporarily imported/ </b>
                                <em>M&#259;rfurile care fac obiectul declara&#539;iei sus-men&#539;ionat&#259; au fost
                                    importate temporar</em>
                                <br><br>
                                <br>
                                <br>
                                <br>
                            ...
                            <div class="letter">
                                <div>b)</div>
                                <b>Final date for duty-free re-exportation:/</b>
                                <em> Data limit&#259; pentru reexportul/prezentarea m&#259;rfurilor &#238;n vam&#259;:</em>
                                <table id="valid_date">
                                    <tr>
